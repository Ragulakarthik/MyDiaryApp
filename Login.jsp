...
<html>
    ...
    <body>
        <div id="MainDiv">
            ...
            <div id="LoginDiv">
                <b style="font-size: 40px; color:orangered; margin-left: 35%; margin-top: 15%; float: left;">Login Here</b>
                <form action="./authen" method="POST">
                    <table style="font-size: 30px; margin-left: 10%; margin-top: 5%; float: left;">
                        ...
                        <tr>
                            <td colspan="2" align="center">
                                <b style="font-size: 20px;">New User? <a href="./Register" style="cursor: pointer; color: blue;">Register Here</a></b>
                            </td>
                        </tr>
                    </table>
                </form>
