    ...
    <body>
        <div id="MainDiv">
            ...
            <div id="UpdateEntryDiv">
                ...
                <b style="font-size: 40px; color:orangered; margin-left: 25%; margin-top: 5%; float: left;">Update Your Entry Here</b>
                <form action="./processentryupdate" method="POST">
                    <table style="font-size: 30px; margin-left: 10%; margin-top: 5%; float: left;">
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea name="description" style="height: 150px; width: 400px; font-size: 20px; border: 1px solid black">${list.description}</textarea>
                            </td>
                        </tr>
                        <tr>
